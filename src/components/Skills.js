    ...
    return (
        <section id = "skills" className="skills u-section-padding">
            ...
            <ul className="skills__list skills__list--left">
                ...
                <img src={require("../img/git-icon.png")} alt="" className="skills__list__icon"/>
                <li className="skills__list__item skills__list__item--4">Git and NPM</li>
                <img src={require("../img/git-icon.png")} alt="" className="skills__list__icon"/>
                <li className="skills__list__item skills__list__item--4">4 years working and collaborating with other engineers and architects </li>
            ...
            <li className="skills__list__header heading-small ">Currently Learning:</li>
                ...
                <img src={require("../img/typescript.svg")} alt="" className="skills__list__icon"/>
                <li className="skills__list__item skills__list__item--7">Typescript</li>
                <img src={require("../img/jest-logo.svg")} alt="" className="skills__list__icon"/>
